<template>
    <div>
        ...
        <form action="https://formspree.io/f/moqznpko" method="POST">
        <div class="container">
            <div class="card">
                <a class="login">Contact Us!</a>
                <div class="inputBox">
                    <input type="text" v-model="cellnumber" placeholder="0812345678" required="required">
                    <span>Cellphone Number</span>
                </div>
                <div class="inputBox">
                    <input type="email" name="email" v-model="email" placeholder="user314@gmail.com" required="required">
                    <span>E-mail</span>
                </div>
                <div class="inputBox">
                    <input type="text" name="message" v-model="text" placeholder="Leave a message for us" required="required">
    ...
    <section class="footer">
        ...
        <div class="footer-links">
            ...
            <div class="list">
              <ul>
                ...
                <li><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                  ...
                  </svg>34 Mtimka Street New Brighton, Port Elizabeth</a></li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="list">
              <ul>
                <li><a href="https://www.instagram.com/_theshoecleanic/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
